                        ...
                        <div className="HomeHero-contentInner">
                          ...
                          <h1 className="HomeHero-title">
                            <div className="HomeLetters">
                              ...
                              >
                                {" "}
                                <path d="M118.058 0.957886C139.367 0.957886 156.643 18.1954 156.643 39.455V412.147H84.1312V230.578C84.1312 224.161 78.9292 218.959 72.5121 218.959V218.959V412.147H0V39.455C0 18.1954 17.2768 0.957886 38.5849 0.957886H118.058ZM72.5121 196.104C78.9292 196.104 84.1312 190.902 84.1312 184.485V43.8388C84.1312 37.4218 78.9292 32.2197 72.5121 32.2197V32.2197V196.104V196.104Z"></path>
                              </svg>
                              <svg
                                width="157"
                                height="413"
                            ...
                            <div className="Homepage-ProjectItem project-item">
                              ...
                              >
                                <div className="ProjectItem-imageContainer">
                                  <div className="ProjectItem-image">
                                    <img
                                      src="https://cdn.sanity.io/images/zvxprgaj/production/3…x1720.jpg?w=1080&h=1002&q=80&fit=crop&auto=format"
                                      alt=""
                                    />
                                  </div>
                                </div>
                    ...
                    <div className="HomeProjectsDesc">
                      <div className="HomeProjectsDesc-content">
                        ...
                        <p className="SplitText AnimatedSplitText HomeProjectsDesc-text">
                          Creativity and innovation drive our process, fueled by
                          a commitment to uniqueness and tailor‑made solutions.
                          We joyfully reject the ordinary, the familiar, and the
                          commonplace, always striving to chart new territories
                          in our work.
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="HomeAwardsHero-content">
                          <div className="HomeAwardsHero-contentLeft">
                            ...
                            <div className="HomeAwardsHero-intro">
                              <p className="SplitText AnimatedSplitText">
                                Every project we undertake prioritizes
                                excellence, aiming to captivate your visitors
                                with a compelling and impactful online
                                experience. We firmly believe in the unmatched
                                value of immersive experiences, particularly
                          ...
                          <div className="HomeAwardsNumbers HomeAwardsHero-numbers">
                            ...
                            <div className="AppText-12">
                              <p>
                                The Awwwards recognize the best web agencies in
                                the world by celebrating the most cutting-edge,
                                creative, or innovative websites and digital
                                experiences.
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="HomeExpertisesItem-inner --index-first">
                      <div className="HomeExpertisesItem-innerSticky">
                        ...
                        <div className="HomeExpertisesItem-content">
                          ...
                          <a
                            href=""
                            className="AppButton HomeExpertisesItem-button"
                          >
                            <div className="AppButton-border"></div>
                            <div className="AppButton-label">
                              <span>See expertise</span>
                            </div>
                            <div className="AppButton-svgWrap">
                              <div className="AppButton-svgWrapDot"></div>
                              <div className="AppButton-arrowWrap">
                                <span className="AppButton-svg">
                                  <ArrowIcon />
                                </span>
                              </div>
                            </div>
                        ...
                        <div className="HomeExpertisesItem-imageContainer">
                          <div className="HomeExpertisesItem-imageContainerInner">
                            <div className="AppImage HomeExpertisesItem-image">
                              <img src="https://cdn.sanity.io/images/zvxprgaj/production/f95ae49c2accec3c6f28026f270343eb5ab2cd6f-1580x1580.jpg?w=506&h=366&q=80&fit=crop&auto=format"></img>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="HomeExpertisesItem-inner --index-between">
                      <div className="HomeExpertisesItem-innerSticky">
                          ...
                          <div className="HomeExpertiesItem-contentText">
                            <div className="AppText-12 --style-bullets">
                              <div className="list">
                                ...
                                <div className="breaker"></div>
                                <div className="even item">Graphic charter</div>
                                <div className="item">Graphic design</div>
                                <div className="breaker"></div>
                                <div className="even item">
                        ...
                        <div className="HomeExpertisesItem-imageContainer">
                          <div className="HomeExpertisesItem-imageContainerInner">
                            <div className="AppImage HomeExpertisesItem-image">
                              <img src="https://cdn.sanity.io/images/zvxprgaj/production/8da3d80e45c9838650a8c587441b5475fe1b9bb1-1580x1580.jpg?w=506&h=366&q=80&fit=crop&auto=format"></img>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="HomeExpertisesItem-inner --index-between">
                      <div className="HomeExpertisesItem-innerSticky">
                        ...
                        <div className="HomeExpertisesItem-imageContainer">
                          <div className="HomeExpertisesItem-imageContainerInner">
                            <div className="AppImage HomeExpertisesItem-image">
                              <img src="https://cdn.sanity.io/images/zvxprgaj/production/05d66dc16dc9f7d287f7784e1048c7d4c18f44cc-1580x1580.jpg?w=506&h=366&q=80&fit=crop&rect=0,0,1580,1560&fp-x=0.5&fp-y=0.4937185929648241&auto=format"></img>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="HomeExpertisesItem-inner --index-last">
                      <div className="HomeExpertisesItem-innerSticky">
                          ...
                          <div className="HomeExpertiesItem-contentText">
                            <div className="AppText-12 --style-bullets">
                              <div className="list">
                                ...
                                <div className="breaker"></div>
                                <div className="even item">Gaming</div>
                                <div className="item">Storyboard</div>
                                <div className="breaker"></div>
                                <div className="even item">Art Direction</div>
                        ...
                        <div className="HomeExpertisesItem-imageContainer">
                          <div className="HomeExpertisesItem-imageContainerInner">
                            <div className="AppImage HomeExpertisesItem-image">
                              <img src="https://cdn.sanity.io/images/zvxprgaj/production/4bcc343a1d89969391cd79bf875e8481ea07ae7e-1580x1580.jpg?w=506&h=366&q=80&fit=crop&auto=format"></img>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="Footer-inner">
                <div className="Contact-list">
                  <div className="Contact-item">
                    <div className="AppList Contact-address">
                      <a href="https://www.google.com/maps/search//?api=1&query=Akaru9quaiAndr%C3%A9Lassagne69001LyonFrance">
                        <p>Akaru</p>
                  ...
                  <div className="Contact-item">
                    ...
                    <div className="copyright">Akaru© 2023</div>
                  </div>
                </div>
                <div className="footer-bottom">
                  <div className="Letters Footer-letters">
                    <svg
                      width="157"
                      height="413"
                      viewBox="0 0 157 413"
